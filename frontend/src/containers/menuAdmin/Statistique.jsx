  ...
  useEffect(() => {
    ...
    newSocket.on("new_orderitems", (data) => {
      ...
      setOrders((prev) => {
        ...
        // Calculer les stats avec les nouvelles données
        computeStats(newOrders);
        return newOrders;
      });
    });
  ...
  const computeStats = (data) => {
    ...
    const hourly = hoursRange.map((h) => {
      ...
      ordersInHour.forEach((o) => {
        ...
        burgerCount[name].revenue += getRevenue(o); //o.total_revenue; // item.price * item.quantity;
        // });
      });
    ...
    weeklyOrders.forEach((o) => {
      ...
      weeklyCount[name].revenue += getRevenue(o); //o.total_revenue; // item.price * item.quantity;
      // });
    });
    ...
    monthlyOrders.forEach((o) => {
      ...
      monthlyCount[name].revenue += getRevenue(o); //o.total_revenue; // item.price * item.quantity;
      //   });
    });
